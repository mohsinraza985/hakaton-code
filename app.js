...
function onEdit(td) {
    ...
    document.getElementById("therName").value = selectedRow.cells[0].innerHTML;
...
function validate() {
    ...
    if (document.getElementById("fatherName").value == "") {
        isValid = false;
        document.getElementById("fatherNamevalidationError").classList.remove("hide");
    } else {
        isValid = true;
        if (!document.getElementById("fatherNamevalidationError").classList.contains("hide"))
        {
            document.getElementById("fatherNamevalidationError").classList.add("hide");
        }
    }
